...
INSERT INTO tomes (
    ...
    tome_image,
    tome_dedicace,
    tome_edition_speciale,
    tome_edition_speciale_libelle,
    serie_id)
VALUES
    (3,							-- tome_numero
    '7 jours pour mourir',		-- tome_titre
    8.50,						-- tome_prix_achat
    NULL,						-- tome_valeur_connue
    199404,						-- tome_date_edition
    '2803603160',				-- tome_isbn
    './images/test.jpg',		-- tome_image
    0,							-- tome_dedicace
    0,							-- tome_edition_speciale
    NULL,						-- tome_edition_speciale_libelle
    1)							-- tome_id 18
;
