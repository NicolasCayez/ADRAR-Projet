...
public class AuteurPseudoBean extends AuteurBean{
    ...
    public AuteurPseudoBean(int auteur_id, String auteur_nom, String auteur_prenom, String auteur_pseudo) {
        super(auteur_id, auteur_nom, auteur_prenom, auteur_pseudo);
    }
