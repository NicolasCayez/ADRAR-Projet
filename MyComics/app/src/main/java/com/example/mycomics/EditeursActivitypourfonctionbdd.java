...
public class EditeursActivitypourfonctionbdd extends AppCompatActivity implements View.OnClickListener {
...
//        }));
        ...
        findViewById(R.id.btnMenuCollection).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent intent = new Intent(EditeursActivitypourfonctionbdd.this, CollectionActivity.class);
//                startActivity(intent);
            }
        });
        ...
        findViewById(R.id.btnMenuSeries).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent intent = new Intent(EditeursActivitypourfonctionbdd.this, SeriesActivity.class);
//                startActivity(intent);
            }
        });
        ...
        findViewById(R.id.btnMenuTomes).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent intent = new Intent(EditeursActivitypourfonctionbdd.this, TomesActivity.class);
//                startActivity(intent);
            }
        });
        ...
        findViewById(R.id.btnMenuAuteurs).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent intent = new Intent(EditeursActivitypourfonctionbdd.this, AuteursActivity.class);
//                startActivity(intent);
            }
        });
        ...
        findViewById(R.id.btnMenuReglages).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent intent = new Intent(EditeursActivitypourfonctionbdd.this, ReglagesActivity.class);
//                startActivity(intent);
            }
        });
        /* -------------------------------------- */
        ...
        binding.btnAddEditeurs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Création Popup
                PopupAddDialog popupAddDialog = new PopupAddDialog(EditeursActivitypourfonctionbdd.this);
...
//                            Toast.makeText(ReglagesActivity.this, "Erreur création éditeur", Toast.LENGTH_SHORT).show();
                        ...
                        dataBaseHelper = new DataBaseHelper(EditeursActivitypourfonctionbdd.this);
        ...
        binding.lvEditeursListe.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(EditeursActivitypourfonctionbdd.this, EditeursDetailActivity.class);
    ...
    private void afficherListeEditeurs(){
        editeursArrayAdapter = new EditeursListAdapter(EditeursActivitypourfonctionbdd.this , R.layout.listview_template , dataBaseHelper.selectAllFromEditeursNomSeul());
