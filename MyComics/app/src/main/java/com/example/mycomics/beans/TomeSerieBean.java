...
public class TomeSerieBean extends TomeBean {
        private String serie_nom, editeur_nom;
        DataBaseHelper dataBaseHelper;
    /* -------------------------------------- */
    // Constructeur
    /* -------------------------------------- */
    public TomeSerieBean(Integer tome_id, String tome_titre, int tome_numero, String tome_isbn, String tome_image, double tome_prix_editeur, double tome_valeur_connue, String tome_date_edition, boolean tome_dedicace, boolean tome_edition_speciale, String tome_edition_speciale_libelle, Integer serie_id, Integer editeur_id, String serie_nom) {
        ...
        this.serie_nom = dataBaseHelper.selectAllFromSeriesSelonSerieId(serie_id).getSerie_nom();
    }
